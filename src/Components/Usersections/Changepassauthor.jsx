...
import { ChangeUserAuthorpassApi } from "../../Api/Authors/AuthorsSlice";

const Changepassauthor = () => {
        ...
        // Handle form submit
         const handleSubmit = (e) => {
           ...
           if (Object.keys(error_submit).length === 0) {
             dispatch(ChangeUserAuthorpassApi(formData)).then((res) => {
...
export default Changepassauthor