...
const Profile = () => {
  ...
  const roleoption = userdata?.roles?.map((data) => ({
    value: data,
    label: data,
  })) || [];  
    ...
    <div class="content">
      ...
      <div class="page-content-wrapper">
        <div class="container-fluid">
          <div class="row">
            <Breadcrumb page={t("global.profile.account_settings")} />
          </div>
          {loading !== "loading" ? (
        <>
            ...
            {Object.keys(userdata).length !== 0 ? (
              <>
                ...
                <div className="card border-0 mt-3 mx-auto p-4 shadow profile-card">
                  ...
                  <div className="row mt-4 mb-5">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12">
                      <div className="mb-3">
                <label htmlFor="City" className="form-label"> {t("global.profile.gender.label")}</label>
                <select
                  name="gender"
                ...
                >
                  ...
                  <option  value={'male'}>{t("global.profile.gender.male")}</option>
                  <option  value={'Female'}>{t("global.profile.gender.female")}</option>
