...
import { AddHomeApi, GetHomeApi, UpdateHomeApi } from "../../Api/App/App";
...
const AddBanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(error_submit).length === 0) {
      ...
      setErrorvalid(null);
      dispatch(AddHomeApi(data)).then((res) => {
        if (res && res.payload) {
    ...
    <div class="content">
      ...
      <div class="page-content-wrapper">
        <div class="container-fluid">
          <div class="row">
            <Breadcrumb page={t("global.nav.menu.banner_management.create")} />
          </div>
          <form class="" action="#">
